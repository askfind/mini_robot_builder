...
#define FQCK 7372800  // Frequencies Crystal Gh
...
void TransmitByte( unsigned char data );*/
        ...
        void    Init_B_UART0  ( unsigned char SizeBit );     // Size Bits Rx/Tx         
    ...
    */
    ...
    void   ControlStream_ON_UART0( void );   // Set Echo = 1 Mode 'ON'

        /*-----------------------------*/
        /*  Control stream  UART0 mode */
    void   ControlStream_OFF_UART0( void );   // Set Echo = 1 Mode ' 
   ...
   void     DSR_CLR_UART0( void );         // Set DSR = 0
        ...
        /*--------------------------*/
        /*  "CTS_ON_CONTR_UART0"    */
   void     CTS_ON_CONTR_UART0( void );    // Control DSR ON
         /*-------------------------*/
        /*  "CTS_OFF_CONTR_UART0"   */
   void     CTS_OFF_CONTR_UART0( void );   // Control DSR OFF
         /*-------------------------*/
        /*  "CTS_SET_UART0"         */
   void     CTS_SET_UART0( void );         // Set DSR = 1
        /*---------------------*/
        /*  "CTS_CLR_UART0"    */
   void     CTS_CLR_UART0( void );         // Set DSR = 0
...
unsigned char CheckParity7(unsigned char byte);

/*----------------------*/
/* Function CheckParity */
unsigned char CheckParity8(unsigned char byte);
