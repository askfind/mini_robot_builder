/*                      - FRMWRI_P.C -
   ...
   Variant for program address space format string.
   ...
   Version: 1.04 [IPEO] (from frmwri V3.33G)
...
#include "stdarg.h"
#include "float.h"
#include "iccutl_p.h" /* Low-level declarations */
#include "sysmac.h"
...
int _formatted_write_P (PGM_P format,
...
#ifndef REDUCED_SUPPORT
  {
    ...
    PGM_P hex;
    PGM_P flash_pointer=0;
    static __flash char hexDigits[] = "0123456789ABCDEF"; 
    static __flash char hexDigitsSmall[] = "0123456789abcdef";
    static __flash char null_pointer_str[] = "(null pointer)";
    static __flash char three_Q_Mark[] = "???";
#ifndef FLOAT_SUPPORT
    static __flash char wrong_float[] = "FLOATS? wrong formatter installed!";
#endif
    ...
    /*===================================================*/
        ...
        /*=======================*/
            INTEGRAL_CONVERSION:
              ...
              if (precision !=0 || nonzero_value)  /* No char if zero and zero precision */
              do
    ...
    /*========================*/
        while (--precision >= 0)
          {
            if(flash_pointer)
              put_one_char(*flash_pointer++, secret_pointer);
            else
