...
/* Extended I/O space */
SFR_B_EXT(DDRF,   0x61)     /* Data Direction Register, Port F */
SFR_B_EXT(PORTF,  0x62)     /* Data Register, Port F */
SFR_B_EXT(PING,   0x63)     /* Input Pins, Port G */
SFR_B_EXT(DDRG,   0x64)     /* Data Direction Register, Port G */
SFR_B_EXT(PORTG,  0x65)     /* Data Register, Port G */
SFR_B_EXT(SPMCSR, 0x68)     /* Store Program Memory Control and Status Register */
...
SFR_B_EXT(OCR1CL, 0x78)     /* Timer/Counter 1 Output Compare Register C Low */
SFR_B_EXT(OCR1CH, 0x79)     /* Timer/Counter 1 Output Compare Register C High */
SFR_B_EXT(TCCR1C, 0x7A)     /* Timer/Counter 1 Control Register C */
...
SFR_B_EXT(ICR3L,  0x80)     /* Timer/Counter 3 Input Capture Register Low */
SFR_B_EXT(ICR3H,  0x81)     /* Timer/Counter 3 Input Capture Register High */
SFR_B_EXT(OCR3CL, 0x82)     /* Timer/Counter 3 Output Compare Register C Low */
SFR_B_EXT(OCR3CH, 0x83)     /* Timer/Counter 3 Output Compare Register C High */
SFR_B_EXT(OCR3BL, 0x84)     /* Timer/Counter 3 Output Compare Register B Low */
SFR_B_EXT(OCR3BH, 0x85)     /* Timer/Counter 3 Output Compare Register B High */
SFR_B_EXT(OCR3AL, 0x86)     /* Timer/Counter 3 Output Compare Register A Low */
SFR_B_EXT(OCR3AH, 0x87)     /* Timer/Counter 3 Output Compare Register A High */
SFR_B_EXT(TCNT3L, 0x88)     /* Timer/Counter 3 Register Low */
SFR_B_EXT(TCNT3H, 0x89)     /* Timer/Counter 3 Register High */
SFR_B_EXT(TCCR3B, 0x8A)     /* Timer/Counter 3 Control Register B */
SFR_B_EXT(TCCR3A, 0x8B)     /* Timer/Counter 3 Control Register A */
SFR_B_EXT(TCCR3C, 0x8C)     /* Timer/Counter 3 Control Register C */
